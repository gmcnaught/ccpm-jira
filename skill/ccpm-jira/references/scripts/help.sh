...
echo "  4. /pm:epic-sync <name>      - Push to Jira"
...
echo "  /pm:issue-sync <num>      - Push updates to Jira"
...
echo ""
echo "🔗 Sync Commands"
echo "  /pm:sync               - Full sync with Jira"
echo "  /pm:import <key>       - Import existing Jira issues"
echo ""
...
echo "  /pm:init               - Initialize and configure Jira"
echo "  /pm:help               - Show this help message"
echo ""
echo "💡 Tips"
echo "  • Use /pm:next to find available work"
echo "  • Run /pm:status for quick overview"
echo "  • Epic workflow: prd-new → prd-parse → epic-decompose → epic-sync (to Jira)"
